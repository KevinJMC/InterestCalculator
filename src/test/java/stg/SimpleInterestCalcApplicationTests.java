...
public class SimpleInterestCalcApplicationTests {
    ...
    @Test
    //simple interest w/ normal balance, recurring deductions, not exceed
    // interest earned
    ...
    @Test
    //simple interest w/ normal balance, recurring deductions, exceed
    // interest earned
    public void normalBalanceRecurringDeductionsExceedInterestEarned() {
        Account account = new Account();
        RecurringTransaction recurringTransaction = new RecurringTransaction(1,
                                                                             -200);
        account.setBalance(1000);
        account.setInterestRate(.01);
        double expected = 0;
    ...
    @Test
    //simple interest below RMB w/ recurring contributions will not bring
    // account above RMB
    ...
    @Test
    //simple interest below RMB w/ recurring contributions will bring account
    // above RMB
    ...
    @Test
    //simple interest low balance account will overdraw w/ recurring
    // contributions will not bring above $0
    public void
    lowBalanceAccoutWillOverdrawReucrringContributionsNotBringAboveZero() {
        Account account = new Account();
        RecurringTransaction recurringTransaction = new RecurringTransaction(1,
                                                                             -500);
        RecurringTransaction recurringTransaction1 = new RecurringTransaction(1,
                                                                              100);
        account.setBalance(100);
        account.setInterestRate(.01);
        double expected = 0;
    ...
    @Test
    //simple interest low balance account will overdraw w recurring
    // contributions will bring above $0
