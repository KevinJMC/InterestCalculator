...
//     }
//
//     public OldLedger(Collection<? extends E> c) {
//         this();
//         addAll(c);
//     }
//
...
//         int batch;
//
//         LedgerSpliterator(OldLedger<E> ledger, int est, int expectedModCount) {
//             this.ledger = ledger;
//             this.est = est;
...
//
//     @SuppressWarnings("unchecked")
//     private OldLedger<E> superClone() {
//         try {
//             return (OldLedger<E>) super.clone();
...
// }
//
// class SubList<E> extends OldLedger<E> {
//     private final OldLedger<E> ledger;
//     private final int offset;
//     private int size;
//
//     SubList(OldLedger<E> ledger, int fromIndex, int toIndex) {
//         if (fromIndex < 0) {
...
//
//     RandomAccessSubList(OldLedger<E> ledger, int fromIndex, int toIndex) {
